...
class InstaBot:
    ...
    Founder: https://github.com/LevPasha/
    Original version (v 0.05): https://github.com/jaguar754/instabot.py
    Current version author (me): https://github.com/artemfind5
    """
    ...
    def __init__(self, login, password,
        ...
        log_string = 'Insta Bot v%s start at %s:' %\
                     (self.botversion, now_time.strftime("%d.%m.%Y %H:%M"))
